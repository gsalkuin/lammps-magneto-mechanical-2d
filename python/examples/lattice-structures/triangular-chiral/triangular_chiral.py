...
m_dip_per_block = 19*[m_dip*np.array([0, 0, 0])] + [None]

m_dip_per_block[0] = m_dip*np.array([1, 0, 0])
for i in range(1,7):
...
Y_mod_per_block = 19*[None] + [Y_mod]
rho_per_block = 19*[rho_m] + [rho_e]
