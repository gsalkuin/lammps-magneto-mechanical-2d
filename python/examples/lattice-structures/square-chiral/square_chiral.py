...
m_dip_per_block = 21*[m_dip*np.array([1, 0, 0])] + [None]
for i in (1,3,5,6,7,9,11,13,14,15,17,19):
    m_dip_per_block[i] = m_dip*np.array([-1, 0, 0])

##############################################################################
# Create the metamaterial

Y_mod_per_block = 21*[None] + [Y_mod]
rho_per_block = 21*[rho_m] + [rho_e]
